# Generated by Django 5.2.14 on 2026-06-19 22:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projects', '0019_user_roles_and_worker_fk'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('owner', 'Owner'), ('worker', 'Worker')], max_length=20, verbose_name='Ρόλος')),
                ('permission', models.CharField(max_length=50, verbose_name='Δικαίωμα')),
                ('allowed', models.BooleanField(default=False, verbose_name='Επιτρέπεται')),
            ],
            options={
